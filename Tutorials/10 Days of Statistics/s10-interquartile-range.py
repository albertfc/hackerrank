...
def main( args ):
	...
	elems = list(map( int, args.in_file.readline().split() ))
	freqs = list(map( int, args.in_file.readline().split() ))
	...
	log.msg( "{:.1f}".format( q3 - q1 ) )


def get_args( ):
	parser = argparse.ArgumentParser( description="Calculates interquartile range" )
